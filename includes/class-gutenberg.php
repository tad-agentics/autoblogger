...
class AutoBlogger_Gutenberg {
    ...
    public function enqueue_assets() {
        ...
        $asset_file = AUTOBLOGGER_PATH . 'assets/js/editor/build/index.asset.php';
        ...
        wp_enqueue_script(
            $script_handle,
            AUTOBLOGGER_URL . 'assets/js/editor/build/index.js',
            $asset['dependencies'],
            $asset['version'],
            true // Load in footer
        );
        ...
        wp_enqueue_style(
            'autoblogger-editor',
            AUTOBLOGGER_URL . 'assets/js/editor/build/style-index.css',
            ['wp-edit-post'],
            $asset['version']
        );
